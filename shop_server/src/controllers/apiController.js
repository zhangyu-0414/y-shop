  ...
  let resObj = {
    status: successState, message: [{
      ...
      // img: 'http://www.liulongbin.top:3005/images/lunbo1-min.jpg'
		  img: 'https://img2.baidu.com/it/u=7218308,1231469511&fm=253&fmt=auto&app=120&f=GIF?w=348&h=382'
    }, {
		id: 2,
      url: 'http://www.itcast.cn/subject/phoneweb/index.html',
      // img: 'http://www.liulongbin.top:3005/images/lunbo2-min.jpg'
		img: 'https://img1.baidu.com/it/u=3221987843,3765329914&fm=253&fmt=auto&app=138&f=JPEG?w=356&h=311'
    }, {
		id: 3,
      url: 'http://www.itcast.cn/subject/phoneweb/index.html',
      // img: 'http://www.liulongbin.top:3005/images/lunbo3-min.jpg'
		img: 'https://img2.baidu.com/it/u=1866238724,2048027589&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500'
    },
    {
      id: 4,
      url: 'http://www.itcast.cn/subject/phoneweb/index.html',
        // img: 'http://www.liulongbin.top:3005/images/lunbo3-min.jpg'
      img: 'https://img2.baidu.com/it/u=807059832,1478304377&fm=253&fmt=auto&app=138&f=JPEG?w=640&h=480'
    }
  ]
  }
  ...
  req.db.driver.execQuery(sql, (err, datas) => {
    ...
    if (err) {
	  ...
	  datas.forEach(item => {
		// http://ofv795nmp.bkt.clouddn.com/
		// http://vue.studyit.io
		item.img_url = 'https://img0.baidu.com/it/u=530426417,2082848644&fm=253&fmt=auto&app=138&f=JPEG?w=889&h=500'
	  })
...
exports.getimage = (req, res) => {
  ...
  req.db.driver.execQuery(sql, (err, data) => {
	...
	data.forEach(item => {
		// http://ofv795nmp.bkt.clouddn.com/
		// http://vue.studyit.io
		item.src = 'https://img2.baidu.com/it/u=1866238724,2048027589&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500'
	})
